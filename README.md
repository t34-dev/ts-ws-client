...
You can see a live demo of this package in action at our [GitHub Pages demo site](https://well-do-it-too.github.io/ts-websocket-client/).
...
```typescript
import { greet, doubleNumber, getMyName } from '@well-do-it-too/ts-websocket-client';
...
2. Import and use in your React component:
   ...
   import { greet, doubleNumber } from '@well-do-it-too/ts-websocket-client';
...
2. Use in your Node.js script:
   ```javascript
   const { greet, doubleNumber } = require('@well-do-it-too/ts-websocket-client');
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Well-do-it-too/ts-websocket-client.git
   cd ts-websocket-client
   ```
